import type { ExplorePost } from './explore-post-card';

export const sampleExplorePosts: ExplorePost[] = [
  {
    id: '1',
    userName: 'John Doe',
    profileImage: 'https://i.pravatar.cc/150?img=12',
    timePosted: '2h ago',
    category: 'Friday Soccer',
